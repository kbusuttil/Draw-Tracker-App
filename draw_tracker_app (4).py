...
if pdf_files and inspections_file and sage_file:
    with st.spinner("Processing files..."):
        ...
        for file in pdf_files:
            ...
            # Extract a line with street-style address
            ...
            best_match = process.extractOne(address_line, inspections_df["Property Address"], scorer=fuzz.token_sort_ratio)
            if best_match and best_match[1] >= 90:
                matched_row = inspections_df[inspections_df["Property Address"] == best_match[0]].iloc[0]
                loan_id = matched_row["Loan ID"]
            else:
                loan_id = ""
